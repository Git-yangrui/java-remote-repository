...
public class FlowCountSort
{
    ...
    extends Mapper<LongWritable, Text, FlowCountBean, NullWritable>
  {
    ...
    protected void map(LongWritable key, Text value, Mapper<LongWritable, Text, FlowCountBean, NullWritable>.Context context)
  ...
  {
    protected void reduce(FlowCountBean bean, Iterable<NullWritable> values, Reducer<FlowCountBean, NullWritable, Text, FlowCountBean>.Context arg2)
      throws IOException, InterruptedException
    {
