...
public class FlowCountDemo {
	public static class FlowCountMapper extends Mapper<LongWritable, Text, Text, FlowCountBean> {
		private FlowCountBean countBean = new FlowCountBean();

		protected void map(LongWritable key, Text value,
				Mapper<LongWritable, Text, Text, FlowCountBean>.Context context)
	...
	public static class FlowCountReducer extends Reducer<Text, FlowCountBean, Text, FlowCountBean> {
		private FlowCountBean countBean = new FlowCountBean();

		protected void reduce(Text key, Iterable<FlowCountBean> values,
				Reducer<Text, FlowCountBean, Text, FlowCountBean>.Context context)
				throws IOException, InterruptedException {
			long up_flow_sum = 0L;
			long dw_flow_sum = 0L;
	...
	public static void main(String[] args) throws Exception {
		...
		instance.setJarByClass(FlowCountDemo.class);
